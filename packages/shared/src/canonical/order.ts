...
export const CanonicalCustomerSchema = z.object({
  ...
  hasEquivalenceSurcharge: z.boolean().optional().default(false), // REQCLI (Recargo de Equivalencia para minoristas)
...
export const CanonicalOrderSchema = z.object({
  ...
  hasEquivalenceSurcharge: z.boolean().optional().default(false),  // REQPCL en Factusol (1 si aplica R.E., 0 si no)
